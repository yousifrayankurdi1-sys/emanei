...
export const SAMPLE_HADITHS: Hadith[] = [
  ...
  { id: 'h21', text: 'الطهور شطر الإيمان، والحمد لله تملأ الميزان، وسُبْحَانَ اللهِ وَالْحَمْدُ لِلَّهِ تَمْلآنِ -أَوْ تَمْلأُ- مَا بَيْنَ السَّمَاوَاتِ وَالأَرْضِ.', narrator: 'أبو مالك الأشعري رضي الله عنه', source: Source.MUSLIM, number: '223', category: Category.WORSHIP, tags: ['الإيمان'] },
  { id: 'h22', text: 'اتق الله حيثما كنت، وأتبع السيئة الحسنة تمحها، وخالق الناس بخلق حسن.', narrator: 'أبو ذر الغفاري رضي الله عنه', source: Source.AGREED, number: '1987', category: Category.MORALS, tags: ['التقوى'] },
  { id: 'h23', text: 'كل مسكر حرام، وإن على الله عز وجل عهدا لمن يشرب المسكر أن يسقيه من طينة الخبال. قالوا: يا رسول الله، وما طينة الخبال؟ قال: عرق أهل النار أو عصارة أهل النار.', narrator: 'جابر بن عبدالله رضي الله عنهما', source: Source.MUSLIM, number: '2003', category: Category.TRANSACTIONS, tags: ['الخمر'] },
  { id: 'h24', text: 'من أحب أن يبسط له في رزقه، وينسأ له في أثره، فليصل رحمه.', narrator: 'أنس بن مالك رضي الله عنه', source: Source.AGREED, number: '5986', category: Category.MORALS, tags: ['صلة الرحم'] },
  { id: 'h25', text: 'انظروا إلى من هو أسفل منكم ولا تنظروا إلى من هو فوقكم، فهو أجدر أن لا تزدروا نعمة الله عليكم.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '2963', category: Category.MORALS, tags: ['القناعة'] },
  { id: 'h26', text: 'آية المنافق ثلاث: إذا حدث كذب، وإذا وعد أخلف، وإذا اؤتمن خان.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '33', category: Category.MORALS, tags: ['النفاق'] },
  { id: 'h27', text: 'من صلى البردين دخل الجنة.', narrator: 'أبو موسى الأشعري رضي الله عنه', source: Source.AGREED, number: '574', category: Category.WORSHIP, tags: ['الصلاة'] },
  { id: 'h28', text: 'الدعاء هو العبادة.', narrator: 'النعمان بن بشير رضي الله عنه', source: Source.BUKHARI, number: '12', category: Category.WORSHIP, tags: ['الدعاء'] },
  { id: 'h29', text: 'من قرأ حرفا من كتاب الله فله به حسنة، والحسنة بعشر أمثالها، لا أقول آلم حرف، ولكن ألف حرف ولام حرف وميم حرف.', narrator: 'عبدالله بن مسعود رضي الله عنه', source: Source.BUKHARI, number: '2327', category: Category.GENERAL, tags: ['القرآن'] },
  { id: 'h30', text: 'إن الصدق يهدي إلى البر، وإن البر يهدي إلى الجنة، وإن الرجل ليصدق حتى يكتب عند الله صديقا.', narrator: 'عبدالله بن مسعود رضي الله عنه', source: Source.AGREED, number: '6094', category: Category.MORALS, tags: ['الصدق'] },
  { id: 'h31', text: 'كل أمتي معافى إلا المجاهرين.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '6069', category: Category.MORALS, tags: ['الستر'] },
  { id: 'h32', text: 'من غدا إلى المسجد أو راح، أعد الله له في الجنة نزلا كلما غدا أو راح.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '662', category: Category.WORSHIP, tags: ['المساجد'] },
  { id: 'h33', text: 'صلاة الجماعة تفضل صلاة الفذ بسبع وعشرين درجة.', narrator: 'عبدالله بن عمر رضي الله عنهما', source: Source.AGREED, number: '645', category: Category.WORSHIP, tags: ['الصلاة'] },
  { id: 'h34', text: 'إذا مات الإنسان انقطع عنه عمله إلا من ثلاثة: إلا من صدقة جارية، أو علم ينتفع به، أو ولد صالح يدعو له.', narrator: 'أبو هريرة رضي الله عنه', source: Source.MUSLIM, number: '1631', category: Category.GENERAL, tags: ['العمل'] },
  { id: 'h35', text: 'من كان في حاجة أخيه كان الله في حاجته، ومن فرج عن مسلم كربة فرج الله عنه كربة من كربات يوم القيامة.', narrator: 'عبدالله بن عمر رضي الله عنهما', source: Source.AGREED, number: '2442', category: Category.MORALS, tags: ['المساعدة'] },
  { id: 'h36', text: 'ما نقصت صدقة من مال، وما زاد الله عبدا بعفو إلا عزا، وما تواضع أحد لله إلا رفعه الله.', narrator: 'أبو هريرة رضي الله عنه', source: Source.MUSLIM, number: '2588', category: Category.MORALS, tags: ['التواضع'] },
  { id: 'h37', text: 'ليس الشديد بالصرعة، إنما الشديد الذي يملك نفسه عند الغضب.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '6114', category: Category.MORALS, tags: ['الصبر'] },
  { id: 'h38', text: 'من صلى علي واحدة صلى الله عليه بها عشرا.', narrator: 'أبو هريرة رضي الله عنه', source: Source.MUSLIM, number: '408', category: Category.WORSHIP, tags: ['الصلاة على النبي'] },
  { id: 'h39', text: 'من دل على خير فله مثل أجر فاعله.', narrator: 'أبو مسعود الأنصاري رضي الله عنه', source: Source.MUSLIM, number: '1893', category: Category.GENERAL, tags: ['الدعوة'] },
  { id: 'h40', text: 'الحياء كله خير.', narrator: 'عمران بن حصين رضي الله عنه', source: Source.MUSLIM, number: '37', category: Category.MORALS, tags: ['الحياء'] },
  { id: 'h41', text: 'تبسمك في وجه أخيك لك صدقة.', narrator: 'أبو ذر الغفاري رضي الله عنه', source: Source.BUKHARI, number: '128', category: Category.MORALS, tags: ['الأخلاق'] },
  { id: 'h42', text: 'أكمل المؤمنين إيمانا أحسنهم خلقا.', narrator: 'أبو هريرة رضي الله عنه', source: Source.BUKHARI, number: '247', category: Category.MORALS, tags: ['الأخلاق'] },
  { id: 'h43', text: 'اتقوا النار ولو بشق تمرة.', narrator: 'عدي بن حاتم رضي الله عنه', source: Source.AGREED, number: '1417', category: Category.WORSHIP, tags: ['الصدقة'] },
  { id: 'h44', text: 'الظلم ظلمات يوم القيامة.', narrator: 'عبدالله بن عمر رضي الله عنهما', source: Source.AGREED, number: '2447', category: Category.MORALS, tags: ['الظلم'] },
  { id: 'h45', text: 'من كان يؤمن بالله واليوم الآخر فليحسن إلى جاره.', narrator: 'أبو هريرة رضي الله عنه', source: Source.MUSLIM, number: '47', category: Category.MORALS, tags: ['الجار'] },
  { id: 'h46', text: 'إن الله جميل يحب الجمال.', narrator: 'عبدالله بن مسعود رضي الله عنه', source: Source.MUSLIM, number: '91', category: Category.AQIDAH, tags: ['الجمال'] },
  { id: 'h47', text: 'الدنيا سجن المؤمن وجنة الكافر.', narrator: 'أبو هريرة رضي الله عنه', source: Source.MUSLIM, number: '2956', category: Category.GENERAL, tags: ['الزهد'] },
  { id: 'h48', text: 'اللهم إنك عفو تحب العفو فاعف عني.', narrator: 'عائشة رضي الله عنها', source: Source.BUKHARI, number: '3295', category: Category.WORSHIP, tags: ['الدعاء'] },
  { id: 'h49', text: 'من صام رمضان إيمانا واحتسابا غفر له ما تقدم من ذنبه.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '38', category: Category.WORSHIP, tags: ['رمضان'] },
  { id: 'h50', text: 'من قام ليلة القدر إيمانا واحتسابا غفر له ما تقدم من ذنبه.', narrator: 'أبو هريرة رضي الله عنه', source: Source.AGREED, number: '1901', category: Category.WORSHIP, tags: ['ليلة القدر'] },
...
// القائمة الكاملة للسور (114 سورة)
